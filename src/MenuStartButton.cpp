...
MenuStartButton* MenuStartButton::pMenuStartButton = nullptr;

MenuStartButton* MenuStartButton::getInstance()
{
    if (pMenuStartButton == nullptr) {
        pMenuStartButton = new MenuStartButton();
    }
    return pMenuStartButton;
}

// constructor
MenuStartButton::MenuStartButton(int iWidth, int iHeight, int iStartX, int iStartY)
...
MenuStartButton::~MenuStartButton() {
    pMenuStartButton = nullptr;
}

void MenuStartButton::virtStart() {
...
void MenuStartButton::virtDraw() {
    ...
    pEngine->drawForegroundString(
        m_iCurrentScreenX - 16 + shakeOffset,
...
void MenuStartButton::drawSprite() {
