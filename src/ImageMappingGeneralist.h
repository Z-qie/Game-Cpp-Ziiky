...
*/
class ImageMappingGeneralist : public ImagePixelMappingRotate
{
public:
	...
	*/
	ImageMappingGeneralist(double r, int iRotationCentreX, int iRotationCentreY)
	...
	virtual ~ImageMappingGeneralist()
	{
	}
