...
MenuIntroButton* MenuIntroButton::pMenuIntroButton = nullptr;

MenuIntroButton* MenuIntroButton::getInstance()
{
    if (pMenuIntroButton == nullptr) {
        pMenuIntroButton = new MenuIntroButton();
    }
    return pMenuIntroButton;
}

// constructor
MenuIntroButton::MenuIntroButton(int iWidth, int iHeight, int iStartX, int iStartY)
...
// destructor
MenuIntroButton::~MenuIntroButton() {
    pMenuIntroButton = nullptr;
}

void MenuIntroButton::virtStart() {
...
void MenuIntroButton::virtDraw() {
    ...
    pEngine->drawForegroundString(
        m_iCurrentScreenX - 30 + shakeOffset,
...
void MenuIntroButton::drawSprite() {
